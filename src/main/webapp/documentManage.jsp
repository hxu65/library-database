...
<body>
	...
	<form action="DocumentControl/search" method="GET">
	<h2></h2>
	...
	<form action="DocumentControl/all" method="GET">
		<h2></h2>
		 <input
			type="submit" value="list" class="button button2" />
	</form>
	<h2>Delete Documents</h2>
	<form action="DocumentControl/delete" method="GET">
		<h2></h2>
		book search: <input type="text" name="iID">
		<h2></h2>
	...
	<h2>Update Documents</h2>
	 <div >
    	<form action="DocumentControl/update" method="get">  
	...
	<h2>add new Documents</h2>
	 <div >
    	<form action="DocumentControl/insert" method="get">  
       		<table border="1" cellpadding="5">
       			<tr>
       				<th>Document ID: </th>
       				<td>
